    ...
    return(
        <div className='min-h-[50vh] grid md:w-5/10 rounded-2xl p-2 md:p-4 border-2 border-black'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="password" name="password" id="password" className='form invalid:border-red-600' minLength={8} onChange={(e)=> setPassword(e.target.value)}  />
                
                 <label htmlFor="confPassword">
                   Confirm Password
                </label>
                <input type="password" name="confirm_password" id="confPassword" className={`border-2 ${passBool ? 'border-blue-700' : 'border-red-400'} outline-none block rounded-xl p-1 indent-4 w-[90%]`} minLength={8} onChange={(e) => confirmPassword(e.target.value)} />
                </fieldset>
