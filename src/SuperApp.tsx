   ...
   async function logOutUser(){
    ...
    return(
      ...
      <div className="md:grid hidden md:col-span-2 md:grid-cols-5 p-1 items-center">
        <Link to='/'>Home</Link>
        <Link to='/me#locations'>Locations</Link>
      ...
      {/*Mobile Nav */}
      <div className="grid col-span-2 md:hidden justify-end">
        ...
        <Link to='/' className="hover:font-bold hover:underline">Home</Link>
        <Link to='/me' className="hover:font-bold hover:underline">Your Profile</Link>
        <Link to='/' className="hover:font-bold hover:underline">Contact Us</Link >
